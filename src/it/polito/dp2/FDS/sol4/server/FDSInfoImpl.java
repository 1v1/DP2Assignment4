...
import it.polito.dp2.FDS.sol4.server.jaxws.info.GetAircrafts;
import it.polito.dp2.FDS.sol4.server.jaxws.info.GetAircraftsResponse;
import it.polito.dp2.FDS.sol4.server.jaxws.info.GetFlight;
import it.polito.dp2.FDS.sol4.server.jaxws.info.GetFlightInstance;
import it.polito.dp2.FDS.sol4.server.jaxws.info.GetFlightInstanceResponse;
import it.polito.dp2.FDS.sol4.server.jaxws.info.GetFlightInstances;
import it.polito.dp2.FDS.sol4.server.jaxws.info.GetFlightInstancesResponse;
import it.polito.dp2.FDS.sol4.server.jaxws.info.GetFlightResponse;
import it.polito.dp2.FDS.sol4.server.jaxws.info.GetFlights;
import it.polito.dp2.FDS.sol4.server.jaxws.info.GetFlightsResponse;
import it.polito.dp2.FDS.sol4.server.jaxws.info.GetPassengers;
import it.polito.dp2.FDS.sol4.server.jaxws.info.GetPassengersResponse;
import it.polito.dp2.FDS.sol4.server.jaxws.info.Info;
import it.polito.dp2.FDS.sol4.server.jaxws.info.InvalidArgument;
import it.polito.dp2.FDS.sol4.server.jaxws.info.InvalidArgument_Exception;
import it.polito.dp2.FDS.sol4.server.jaxws.info.Monitor;
import it.polito.dp2.FDS.sol4.server.jaxws.info.Monitor_Exception;
import it.polito.dp2.FDS.sol4.server.jaxws.info.Time;
import it.polito.dp2.FDS.sol4.server.jaxws.info.UnknownFlight;
import it.polito.dp2.FDS.sol4.server.jaxws.info.UnknownFlightInstance;
import it.polito.dp2.FDS.sol4.server.jaxws.info.UnknownFlightInstance_Exception;
import it.polito.dp2.FDS.sol4.server.jaxws.info.UnknownFlight_Exception;
