...
/**
 * 
 * 				A passenger on a flight instance is uniquely
 * 				identify by her name, the flight id and the departure date of the
 * 				specified flight instance. In fact, a
 * 				single passenger can be
 * 				registered for
 * 				many flight instances.
 * 			
 * 
