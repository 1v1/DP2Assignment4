 ...
 * 
 */
@WebFault(name = "UnknownFlightInstance", targetNamespace = "http://pad.polito.it/FDSControl")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: it.polito.dp2.FDS.sol4.server.jaxws.control.UnknownFlightInstance
     */
